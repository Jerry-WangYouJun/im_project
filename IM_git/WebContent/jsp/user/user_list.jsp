...
<head>
    ...
    <script type="text/javascript">
        ...
        function insertData() {
            var path = "${basePath}/UserServlet?action=add&pageNo=" + $("#pageNo").val() + "&pageSize=" + $("#pageSize").val();
        ...
        function deleteProd() {
            ...
            /* $.ajax({
             type:'POST',
             url : '
            ${basePath}/ProductServlet?action=delete&id=' + id,
             success: function(){
             query($("#pageNo").val());
             },
             error: function(){
...
<div class="main">
    ...
    <form action="${basePath}/UserServlet" method="POST" id="prodForm">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <jsp:include page="user_add.jsp" flush="true"/>
